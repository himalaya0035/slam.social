...
const Success: React.FC = () => {
  ...
  const handleShareOnSocial = (platform: string) => {
    let shareUrl = '';
    const message = `Rate me anonymously on Slam! ${window.location.origin}/feedback/${user?.uniqueId}`;
    ...
    switch (platform) {
      ...
      case 'twitter':
        ...
        break;
      case 'facebook':
        shareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`${window.location.origin}/feedback/${user?.uniqueId}`)}`;
        break;
      default:
        return;
    }
    ...
    <div className="home-container">
      <div className="container">
        <div className="glass-card fade-in">
          ...
          <div className="text-center mb-lg">
            <p className="mb-md">
              Remember, you can only view your results after receiving at least 3 responses.
            </p>
